...
export default class CreateOvEs extends Component {
    ...
    async componentDidMount() {
        const resUs = await axios.get('http://104.193.108.64:4000/api/users', theToken());
    ...
    onSubmit = async (e) => {
        ...
        if (this.state.userSelected && this.state.userSelected) {
            ...
            await axios.put('http://104.193.108.64:4000/api/establecimientos/addUserEstable/' + this.state.estableSelected, addUserEstable, theToken());
            console.log(addUserEstable);
            ...
            await axios.put('http://104.193.108.64:4000/api/ovinos/addEstableUser/' + this.state.userSelected, addEstableUser, theToken());
            console.log(addEstableUser);
            //window.location.href = '/';
        }
    }
